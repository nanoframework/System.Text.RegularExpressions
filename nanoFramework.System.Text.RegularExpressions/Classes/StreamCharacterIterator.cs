    ...
    internal class StreamCharacterIterator : ICharacterIterator
    {
        ...
        public string Range(int beginIndex, int endIndex)
        {
            try
            {
                ...
                return _buff.ToString().Substring(beginIndex, endIndex - beginIndex);
            }
            catch (IOException e)
            {
        ...
        public string Range(int beginIndex)
        {
            ...
            {
                ReadToEnd();
                return _buff.ToString().Substring(beginIndex);
            }
            catch (IOException e)
            {
                throw new ArgumentOutOfRangeException(e.Message);
